// ignore_for_file: unnecessary_import, type_literal_in_constant_pattern, non_constant_identifier_names, avoid_types_as_parameter_names, prefer_const_constructors, sized_box_for_whitespace, unused_local_variable
        ...
        (failure) {
          switch (failure.runtimeType) {
            ...
            case ForbiddenFailure:
              setHomePromoStatus(ref, 'You dan\'t have access');
              break;
        ...
        (failure) {
          switch (failure.runtimeType) {
            ...
            case NotFoundFailure:
              ...
              break;
            case ForbiddenFailure:
              setHomeRecommendationStatus(ref, 'You dan\'t have access');
              break;
            case BadRequestFailure:
    ...
    return Consumer(
        builder: (_, wiRef, __) {
          ...
          return SizedBox(
            ...
            child: ListView.builder(
              scrollDirection: Axis.horizontal,
              itemCount: AppConstant.homeCategories.length,
              itemBuilder: (context, index) {
                String category = AppConstant.homeCategories[index];
                return Padding(
                  padding: EdgeInsets.fromLTRB(
                    index == 0 ? 30 : 0,
                    0,
                    index == AppConstant.homeCategories.length - 1 ? 30 : 8,
                    0,
                  ),
                  child: InkWell(
                    onTap: () {
